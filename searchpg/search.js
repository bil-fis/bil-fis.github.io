...
document.getElementById('so').innerHTML='<center id="soIcon" class="youyuantext">360搜索</center>';
}
...
function sosearch() {
document.getElementById('searchbox').innerHTML='<form action="https://www.so.com/s" target="_blank"> <input style="animation-fill-mode: forwards;" id="search" class="search" type="text" name="q" size="60" placeholder="搜索"/>';
